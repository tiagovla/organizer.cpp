...
#define IN_LOCK_INIT                                                           \
  {                                                                            \
    ...
    if ((res = pthread_rwlockattr_init(&attr)) != 0)                           \
      throw InotifyException(IN_EXC_MSG("cannot initialize lock attributes"),  \
                             res, this);                                       \
...
#define IN_READ_BEGIN                                                          \
  {                                                                            \
    ...
    if (res != 0)                                                              \
      throw InotifyException(IN_EXC_MSG("locking for reading failed"), res,    \
                             (void *)this);                                    \
  }
...
#define IN_WRITE_BEGIN                                                         \
  {                                                                            \
    ...
    if (res != 0)                                                              \
      throw InotifyException(IN_EXC_MSG("locking for writing failed"), res,    \
                             (void *)this);                                    \
  }
